class filter1 {
  ...
  List<ResponseF1>? response;

  filter1({this.statusCode, this.statusMessage, this.response});

  filter1.fromJson(Map<String, dynamic> json) {
    statusCode = json['status_code'];
    statusMessage = json['status_message'];
    if (json['response'] != null) {
      response = <ResponseF1>[];
      json['response'].forEach((v) {
        response!.add(new ResponseF1.fromJson(v));
      });
    }
  }
...
class ResponseF1 {
  ...
  ResponseF1.fromJson(Map<String, dynamic> json) {
